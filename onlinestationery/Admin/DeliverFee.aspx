<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Bootstrap.master" AutoEventWireup="true" CodeFile="DeliverFee.aspx.cs" Inherits="Admin_DeliverFee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <asp:View ID="View1" runat="server">
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="well well-sm">
                    <asp:Button ID="btnAdduser" CssClass="btn btn-warning btn-sm" runat="server" Text="Add New Deliver Fee" OnClick="btnAdduser_Click" />
                    <asp:Button ID="Button1" CssClass="btn btn-warning btn-sm" runat="server" Text="Print" OnClick="btnPrint_Click" />
                </div>

                <div class="panel panel-info">
                    <div class="panel-heading" style="font-size:20px" ><span class="glyphicon glyphicon-list"> </span> Deliver Fee list </div>
                        ...
                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="380px">
                            <asp:GridView ID="grdVcustomersList" runat="server" data-search="true" class="table table-striped" Font-Size="18px" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="100%">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="deliverID" HeaderText="deliverID" Visible="false" />


                                    <asp:BoundField DataField="township" HeaderText="Township" HeaderStyle-HorizontalAlign="Center">

                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:BoundField>

                                    <asp:BoundField DataField="fee" HeaderText="Fee"  HeaderStyle-CssClass="GridItemright" >
        ...
        <asp:View ID="View2" runat="server">
            ...
            <asp:Panel ID="pnlpopupEditView" class="panel panel-primary" runat="server" BackColor="White" Width="300px" DefaultButton="btnSave" HorizontalAlign="Center">
                ...
                <div class="panel-heading">
                    <asp:Label ID="lblName" runat="server" Text="Edit DeliverFee" Font-Size="18px"></asp:Label>
                ...
                <div class="panel-body" style="text-align: left">
                    ...
                    <asp:TextBox ID="DeliverID" Width="275px" Visible="false" runat="server"></asp:TextBox>
                    <asp:Label ID="lblError" runat="server" Font-Size="18px" ForeColor="#CC3300"></asp:Label>
                    <br />

                    <asp:Label ID="Label1" runat="server" Font-Size="18px" Text="Township"></asp:Label><br />
                    <asp:TextBox ID="txttownship"  Width="275px" runat="server"  class="form-control" placeholder="Enter Township Name"></asp:TextBox><br />

                  

                    <asp:Label ID="Label2" runat="server" Font-Size="18px" Text="Fee"></asp:Label><br />
                    <asp:TextBox ID="txtfee"  Width="275px" runat="server"  class="form-control" placeholder="Enter Deliver Fee"></asp:TextBox>
    ...
    <asp:Panel ID="pnlpopupInactive" class="panel panel-primary" runat="server" BackColor="White" Style="display: none" Width="300px" DefaultButton="btnInactive">
        <asp:Label ID="lbldeliverID" runat="server" Text="0"></asp:Label>. 
    <asp:Label ID="lbltownship" runat="server" Text="0"></asp:Label>
        <hr />
        <asp:Label ID="Label7" runat="server" class="label label-info" Text="Do you want to Delete this Township ???"></asp:Label>
        <br />
        <br />
        <div class="panel-footer">
            <asp:Button ID="btnInactive" class="btn btn-success btn-sm" runat="server" Text="Yes" OnClick="DeleteDeliverfee" />
