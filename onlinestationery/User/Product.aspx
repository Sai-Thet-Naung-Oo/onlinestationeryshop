<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/UsermasterOnlynav.master" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="User_Product" %>
                            ...
                            <div class="hero__search">
                                <div class="hero__search__form" style="height: 40px">
                                    ...
                                    <div class="input-group mb-3">
                                      ...
                                      <%--  <input id="Text1" type="text" class="form-control" runat="server"  placeholder="Enter Product Name" aria-label="Recipient's username" aria-describedby="basic-addon2" />--%>
